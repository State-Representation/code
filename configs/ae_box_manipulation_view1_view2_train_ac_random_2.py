...
data_train_opt['dataset_name'] = 'box_manipulation_view1_view2_train_ac_random_2_seed_1122'
data_train_opt['split'] = 'train'
data_train_opt['img_size'] = 256

data_test_opt = {}
data_test_opt['batch_size'] = batch_size
data_test_opt['dataset_name'] = 'box_manipulation_view1_view2_train_ac_random_2_seed_1122'
...
vae_opt = {
    'model': 'AE_TinyResNet', # class name
    'filename': 'vae',
    'num_workers': 4,
